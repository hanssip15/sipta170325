...
<div class="container-fluid text-center">
    ...
    <div class="d-flex justify-content-center gap-2 mb-5">
        <a href="{{ route('perencanaan.kelola-pengajuan.list') }}" class="btn btn-success w-50">Belum Verifikasi</a>
        <a href="{{ route('perencanaan.kelola-pengajuan.ditolak') }}" class="btn btn-secondary w-50">Pengajuan Ditolak</a>
        <a href="{{ route('perencanaan.kelola-pengajuan.diterima') }}" class="btn btn-secondary w-50">Pengajuan Diterima</a>
    </div>
</div>
                ...
                columns: [
                    ...
                    { 
                        ...
                        render: function(data, type, row) {
                            return `<a href="${detailUrl.replace(':id', row.id)}" class="btn btn-primary btn-sm text-center">Detail</a>`;
                        },
                        orderable: false
                    }
                ],
